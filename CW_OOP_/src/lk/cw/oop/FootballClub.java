...
public class FootballClub extends SportsClub{//creating a subclass of sports club class and initialize the variables
    ...
    @Override
    public boolean equals(Object o) {//the hashcode and equals methods for the vehicle class
    ...
    @Override
    public String toString() {//adding the to string method to the vehicle
